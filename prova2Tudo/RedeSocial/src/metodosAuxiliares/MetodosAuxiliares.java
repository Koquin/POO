...
public class MetodosAuxiliares {
	...
	public static RepositorioDePerfisClasse repositorioPerfis = new RepositorioDePerfisClasse();
	...
	public static boolean perfilValido(Perfil perfil, RepositorioDePerfisPostgreSQL repositorioPerfis2) {
		for (Perfil perfis : repositorioPerfis2.getPerfis()) {
	...
	public static boolean postagemValida(Postagem postagem, RepositorioDePostagensClasse repositorioPostagens) {
